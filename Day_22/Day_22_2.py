...
#hard coded bricks after falling to spare time

def find_disintegratable_bricks(filename): #solution: 63166
    """
    bricks = []
...
def is_stable(bricks, i, deps):
    ...
    while len(q):
        ...
        for k in dependencies.keys():
            ...
            if cs[2] < 2 or ce[2]  < 2:
                continue
            if brick in dependencies[k]:
                dependencies[k].remove(brick)
...
#print(find_disintegratable_bricks("example.txt")) #expected: 7
