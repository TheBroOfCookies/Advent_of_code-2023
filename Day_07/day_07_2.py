card_to_sortable = {"2":"a", "3":"b", "4":"c", "5":"d", "6":"e", "7":"f", "8":"g", "9":"h", "T":"i", "J":"1", "Q":"k", "K":"l", "A":"m"} #solution: 253630098
...
def find_type_from_hand(hand):
    ...
    count = sorted(count, key=lambda x: x[1]) #sorted so that last element (count[4]) contains the most prominent card
    if jokers == 5:   #all joker edge case
        return 6
    count[4][1] += jokers #convert jokers to most prominent card
...
#print(find_total_winnings("example.txt"))
