...
def find_energy_sum(filename):  #solution: 6740
    grid = []
    beams = [Beam(np.array([0,-1]), RIGHT)]
    ...
    grid_nrg = move_beams(beams, grid)
    #grid_nrg_print(grid_nrg)
    return np.sum(grid_nrg)
...
print(find_energy_sum("input.txt"))    #wrong: 6180 too low